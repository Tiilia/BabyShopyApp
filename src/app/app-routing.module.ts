import { FormAddAddressComponent } from './Components/user/form-add-address/form-add-address.component';
...
const routes: Routes = [
  ...
  {path: "user/formAddress", canActivate: [AuthGuardService], component: FormAddAddressComponent},
